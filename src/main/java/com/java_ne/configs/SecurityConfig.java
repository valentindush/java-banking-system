package com.java_ne.configs;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.java_ne.dtos.response.ApiResponse;
import com.java_ne.security.CustomUserDetailsService;
import com.java_ne.security.JwtAuthenticationEntryPoint;
import com.java_ne.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private static final String[] AUTH_WHITELIST = {"/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs/**", "/api/documents/download/**", "/api/v1/auth/**", "/api/v1/customer/**"};
